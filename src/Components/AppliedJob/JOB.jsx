...
const JOB = ({job}) => {
    ...
    return (
        <div className='w-3/4 mx-auto flex flex-col md:flex-row items-center md:gap-10 p-2 md:p-4 bg-slate-50 rounded-lg border border-gray-200'>
            ...
            <div className="w-full md:w-3/4 flex justify-between items-center">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-7 justify-between md:justify-normal text-gray-600">
